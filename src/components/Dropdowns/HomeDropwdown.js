            ...
            {({open}) => (
                <>
                    <div className="items-center flex">
                        <Menu.Button
                            className="inline-flex hover:text-lightBlue-600 justify-center w-full rounded-md shadow-sm text-sm font-semibold text-blueGray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-100 focus:ring-indigo-500">
